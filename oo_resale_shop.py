...
itemID : int = 0 # We'll increment this every time we add a new item 
           # so that we always have a new value for the itemID

"""
Sets up the methods and attributes/constructor of the resale shop
"""
class ResaleShop:
    ...
    """
    Takes in the year a computer was made to give price and optionally updates os
    """
